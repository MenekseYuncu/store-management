...
values (default, 'Alice Smith', 'alice.smith@example.com', '123 Maple Street', 1234568, CURRENT_TIMESTAMP, null),
...
values (default, 'Wireless Mouse', 25.499, 150, CURRENT_TIMESTAMP, null),
...
values (default, 1, 0.0, CURRENT_TIMESTAMP, null),
       (default, 2, 0.0, CURRENT_TIMESTAMP, null),
       (default, 3, 0.0, CURRENT_TIMESTAMP, null);

insert into sm_cart_item (id, cart_id, product_id, price, quantity, created_at, updated_at)
values (default, 1, 1, 2, 3, CURRENT_TIMESTAMP, null),
       (default, 1, 2, 1, 3, CURRENT_TIMESTAMP, null),
       (default, 2, 3, 1, 6, CURRENT_TIMESTAMP, null),
       (default, 3, 1, 3, 5, CURRENT_TIMESTAMP, null);

insert into sm_order (id, customer_id, total_price, created_at, updated_at)
values (default, 1, 126.997, CURRENT_TIMESTAMP, null),
...
values (default, 1, 1, 2, 25.499, CURRENT_TIMESTAMP, null),
...
values (default, 1, 20.499, 25.499, CURRENT_TIMESTAMP),
